...
/* CHAT — AI chat with typewriter effect (plain-text, XSS-safe) */
(function () {
  'use strict';
  ...
  // F-015: No innerHTML — append as text nodes (XSS-proof)
